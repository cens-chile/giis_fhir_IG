...
* item[=].item[=].item[=].answerValueSet = "https://paho.org/fhir/giis/ValueSet/CodPaises"
...
* item[=].item[=].item[=].answerValueSet = "https://paho.org/fhir/giis/ValueSet/ProfesionalNotificadorVS"
